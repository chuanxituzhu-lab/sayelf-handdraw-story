...
![A 纸灯旅人极简模型表](storyleaf/示范案例/character-a-default-3-ultra-simple-v1.png)

光头、两只点状眼睛、暖象牙简化躯干、朱红三角围巾和青绿色圆鞋底组成固定身份；彩色总数只有朱红、暖象牙、青绿色三种，黑色线稿不计入。跑、跳、蹲、伸手、转身等复杂动作只改变关节姿势与道具状态，场景可以自由切换。
