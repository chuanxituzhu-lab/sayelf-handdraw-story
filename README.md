...
![A 暖灯女孩极简模型表](storyleaf/示范案例/character-a-default-3-ultra-simple-v2.png)

女生角色，黄色兜帽/头巾、黑色简化短发轮廓、青绿色围巾、暖黄色裙形衣和黑黄小提灯组成固定身份；不要求光头，彩色总数只有暖黄色、青绿色、暖象牙三种，黑色发线与线稿不计入。跑、跳、蹲、伸手、转身等复杂动作只改变关节姿势与提灯位置，场景可以自由切换。

### D 挂坠形制参考：战国刀币缩略形

![战国刀币形铜锈色挂坠参考](storyleaf/示范案例/knife-coin-pendant-copper-patina-v1.png)
